...
class Plant_Entries:
    def __init__(self, gh_id, sensor_type, plant_id, sensor_id, sensor_status, measurement_name, measurement,
                 maintenance_date=None, life_expectancy=None):
        """
        Plant Sensor Entries
        :param gh_id:
        :param sensor_type:
        :param plant_id:
        :param sensor_id:
    ...
    def save_to_db(self):
        ...
        try:
            sql = "INSERT INTO sensor_entries (greenhouse_id,sensor_id,sensor_status," \
                  "measurement_name,measurement,maintenance_date,remaining_days_to_maintenance,remaining_life,life_expectancy,sensor_type,plant_id,measurement_date)" \
            ...
            values = (
                ...
                self.type, self.plant_id, datetime.now().strftime('%Y-%m-%d %H:%M:%S')
            )
            ...
            return{"Message":"There was an error while inserting plant measurements"}
