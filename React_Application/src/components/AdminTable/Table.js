            ...
            >
              <TableHead>
                <TableRow>
                  ...
                  <TableCell className={styles.HeaderCell}>Gender</TableCell>
                  <TableCell className={styles.HeaderCell}>
                    Newsletter
                  </TableCell>
                  <TableCell className={styles.HeaderCell}>
